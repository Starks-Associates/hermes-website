...
@section('content')
	<div>
		<div class="h-[535px] md:h-[884px] flex flex-col justify-end relative" style="background: url('/images/services.jpg') no-repeat; background-size: cover;">
			<div class="max-w-7xl text-white">
				<div class="max-w-4xl md:pl-40 md:pb-40 p-8">
					<p class="font-bold text-4xl md:text-7xl">
						Bespoke services for your capital raise
					</p>
					<p class="text-xl mt-6 md:mt-10">
						Built for businesses aiming for global growth and investors betting on the future of the African market.
					</p>
				</div>
			</div>
		</div>
		<div class="max-w-7xl mx-auto mt-16 md:mt-32 px-6 md:px-0">
			<div class="grid grid-cols-4 md:grid-cols-8 gap-10  items-center">
					...
					<div class="max-w-lg bg-primary py-20">
						...
						<div class="px-10 mt-6">
							...
							<a href="/contact" class="w-full">
								<button class="flex items-center justify-center border-4 border-white px-8 h-14 space-x-3 mt-8 w-full md:w-auto">
	...
	<div class="bg-[#f3f0e1] py-16 md:py-32 mt-32">
		<div class="max-w-7xl px-6 md:px-0 mx-auto">
			<div>
				<p class="text-lg font-medium">Our</p>
				<p class="text-xl md:text-4xl font-bold">Value Preposition</p>
				<div class="grid grid-cols-8 md:grid-cols-8 mt-20">
					<div class="col-span-1 hidden md:block"></div>
					<div class="col-span-8 md:col-span-7 grid grid-cols-2 md:grid-cols-6 gap-4">
						<div class="md:max-w-md col-span-2 md:col-span-6">
							<p class="text-xl md:text-3xl font-semibold">Deep Africa-linked relationships</p>
						</div>
				...
				<div class="grid grid-cols-8 mt-10 md:mt-20">
					<div class="col-span-1 hidden md:block"></div>
					<div class="col-span-8 md:col-span-7 grid grid-cols-2 md:grid-cols-6 gap-4">
						<div class="md:max-w-[250px] col-span-2 md:col-span-6">
							<p class="text-2xl md:text-3xl font-semibold">Companies we work with</p>
						</div>
						<div class="flex items-center col-span-2 space-x-4 mt-6">
							<div class="flex items-center">
								<svg width="76" height="77" viewBox="0 0 76 77" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="py-16 md:py-32">
		<div class="max-w-7xl px-6 md:px-0 mx-auto">
			<div>
				<p class="max-w-sm font-black text-3xl md:text-6xl">
					Full range of services
				</p>
			</div>
			<div class="grid grid-cols-2 md:grid-cols-6 gap-8 mt-20">
	...
	<div class="pb-16 md:pb-32">
		<div class="max-w-7xl px-6 md:px-0 mx-auto">
			<div>
				<div>
					<p class="text-3xl md:text-5xl font-bold max-w-md leading-tight">
						Seeking growth capital (2022)
					</p>
					<div class="flex flex-col md:flex-row md:items-center">
						<div class="md:w-1/4 w-auto">
							<p class="text-3xl text-primary mt-10">
								$ <span class="text-4xl md:text-7xl font-black">50</span> million
							</p>
						...
						<div class="mt-10 md:mt-0">
							<img src="{{ asset('images/target.png') }}" class="w-24 md:w-auto" alt="">
						</div>
					</div>
				</div>
				<div>
